const { Game, GameManager, ICreateGameOptions } = require("@leancloud/client-engine");
...
class Reception extends GameManager {
   ...
   */
  public async makeReservation(playerId) {
    let game;
   ...
   */
  public async createGameAndGetName(playerId, options) {
